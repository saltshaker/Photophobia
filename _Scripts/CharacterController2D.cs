...
public class CharacterController2D : MonoBehaviour
{
	...
	public void recalculateDistanceBetweenRays()
	{
		...
		// horizontal
			var colliderUseableHeight = squareside * Mathf.Abs( transform.localScale.y ) - ( 2f * _skinWidth );
		_verticalDistanceBetweenRays = colliderUseableHeight / ( totalHorizontalRays - 1 );

		// vertical
			var colliderUseableWidth = squareside * Mathf.Abs( transform.localScale.x ) - ( 2f * _skinWidth );
	...
	void primeRaycastOrigins()
	{
		...
		var modifiedBounds = polyCollider.bounds;
